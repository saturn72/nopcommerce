...
{
    /// <summary>
    /// Firebase authentication event consumer (used for saving customer fields on registration)
    /// </summary>
    public class FirebaseAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public FirebaseAuthenticationEventConsumer(ICustomerService customerService)
        {
        ...
        public async Task HandleEventAsync(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(FirebaseAuthenticationDefaults.SystemName))
                return;
